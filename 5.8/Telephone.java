...
public class Telephone
{
   ...
   */
   public Telephone()
   {
      ...
      speakerField.setLineWrap(true);
      JScrollPane speakerFieldScroller = new JScrollPane(speakerField,
              JScrollPane.VERTICAL_SCROLLBAR_ALWAYS,
              JScrollPane.HORIZONTAL_SCROLLBAR_NEVER);
      speakerPanel.add(speakerFieldScroller,
         BorderLayout.CENTER);
      ...
      microphoneField.setLineWrap(true);
      JScrollPane microphoneFieldScroller = new JScrollPane(microphoneField,
              JScrollPane.VERTICAL_SCROLLBAR_ALWAYS,
              JScrollPane.HORIZONTAL_SCROLLBAR_NEVER);
      ...
      microphonePanel.add(new JLabel("Microphone:"),
         BorderLayout.NORTH);
      microphonePanel.add(microphoneFieldScroller,
         BorderLayout.CENTER);
